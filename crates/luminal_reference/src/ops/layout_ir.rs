...
/// analysis, so they live on [`luminal::buffer_tensor_ir::BufferTensorIrOp`]
...
/// [`luminal::buffer_tensor_ir::CloneBufferTensorIrOp`], written once for every
...
/// ([`luminal::buffer_tensor_ir::BufferTensorIrOp`], which outlives analysis
...
pub trait LayoutIrOp:
    luminal::buffer_tensor_ir::BufferTensorIrOp + Bufferizable + ToDps + CloneLayoutIrOp
{
}
...
pub trait OpMatcher: std::fmt::Debug {
    ...
    /// [`luminal::egglog_snippet::assembled_program`]. Every registered
