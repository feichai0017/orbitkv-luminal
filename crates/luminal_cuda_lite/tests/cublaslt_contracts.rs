...
fn call_for(form: CublasLtForm) -> LtCall {
    ...
    LtCall {
        ...
        trans_a: false,
        trans_b: false,
        a: LtDesc { rows: m, cols: k, ld: k },
        b: LtDesc { rows: k, cols: n, ld: n },
        c: LtDesc { rows: m, cols: n, ld: n },
        d: LtDesc { rows: m, cols: n, ld: n },
...
fn ld_bounds_violation_refuses_before_dispatch() {
    ...
    let call = LtCall {
        ...
        trans_a: false,
        trans_b: false,
        a: LtDesc { rows: 1, cols: 2, ld: 2 },
        b: LtDesc { rows: 2, cols: 8, ld: 8 },
        c: LtDesc { rows: 1, cols: 8, ld: 8 },
        d: LtDesc { rows: 1, cols: 8, ld: 8 },
