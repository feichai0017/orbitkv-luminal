//! Offline per-plan proofs for the fp8 crate loop (no HF download):
...
use llama3_1_fp8::model::Fp8Dims;
use llama3_1_fp8::{DecodeStep, Decoder, weights};
