//! Qwen3 as pure logical operations. The model is authored entirely through
...
//! belongs to the backend binding). The checkpoint's bf16 storage and
//! numeric-precision policy are not encoded into this logical graph.
//!
...
/// Architecture hyperparameters for Qwen3-4B.
#[derive(Clone)]
pub struct QwenDims {
    pub vocab: usize,
    pub hidden: usize,
