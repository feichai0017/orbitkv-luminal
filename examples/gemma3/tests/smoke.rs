//! Offline per-plan proofs for the gemma3 crate loop (no HF download)
//! — the tiny dims keep the 5:1-style alternation (pattern 2: layer 0
//! local windowed, layer 1 global scaled-rope):
...
use gemma3::model::Gemma3Dims;
use gemma3::{DecodeStep, Decoder, weights};
